...
def start_weatherman_app() -> None:
    ...
    try:
        weather_controller = WeatherDataController(args.directory)
        weather_controller.load_and_parse_data()
        weather_cal = WeatherCalculations(weather_controller.get_weather_data())
        existing_years = weather_controller.extract_years_from_weather_data()
